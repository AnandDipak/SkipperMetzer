...
<body>
    ...
    <script type="text/javascript" src="https://cdnjs.cloudflare.com/ajax/libs/owl-carousel/1.3.3/owl.carousel.min.js"></script>
        ...
        //enableAutoWidth();
        json = '{ "Entry": { "Title": "", ' +
            '"Image": ["/wp-content/themes/SkipperMetzer/Images/Brochures/ENGLISH-2.jpg",' +
            '"/wp-content/themes/SkipperMetzer/Images/Brochures/ENGLISH-3.jpg",' +
            '"/wp-content/themes/SkipperMetzer/Images/Brochures/ENGLISH-4.jpg" ] } }';
        addGallery(json);
    </script>
    <script type="text/javascript">
        var _gaq = _gaq || [];
