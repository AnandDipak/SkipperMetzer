                    ...
                    <div class="row">
                        <div class="col-md-3">
                          <nav class="nav flex-column card sideNavBar">
                              ...
                              <a class="nav-link " href="#" tabindex="-1" >HDP Pipes for Sprinkler Irrigation</a>
                              <a class="nav-link " href="#" tabindex="-1" >Mini Sprinkler System</a>
                              <a class="nav-link " href="#" tabindex="-1" >Verdit PC Integral Dripline</a>
                          </nav>
                        </div>
                        <div class="col-md-5">
                            <h2>LIN Integral Dripper</h2>
                            <button class="btn downloadBtn mt-4">Download PDF</button>
                            <div class="card text-center align-items-center mt-4">
                                <img src="/wp-content/themes/SkipperMetzer/Images/Products/Lin_001.jpg" alt="LIN" class="img-fluid imgSec">
                            </div>
                        </div>
                        <div class="col-md-4 mt-5">
                            <div class="specificDes mt-5">
                                ...
                                <ul>
                                    ...
                                    <li> Dripline wall thickens: 0.20 to 1.0 mm</li>
                                </ul>
                                <p>Features</p>
                                <ul>
                                    <li> Light flat integral dripper</li>
                                    <li> Large Clog resistant inlet filter</li>
                                    <li> Short and wide labyrinth with turbulent flow pattern prevent clogging</li>
