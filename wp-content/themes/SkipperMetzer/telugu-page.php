<?php
/*
Template Name: Broucher Telugu Page 
*/
?>
...
<body>
        ...
        <main>
            <section class="topBanner">
                <div class="center-items" style=" background: #ffffffb3;width: 400px; text-align:center">
                    <h1 class=" mt-2 text-uppercase p-5">Brouchers</h1>
                </div>
            </section>
            <section class="">
                <div class="container-fluid">
    ...
    <script type="text/javascript" src="https://cdnjs.cloudflare.com/ajax/libs/owl-carousel/1.3.3/owl.carousel.min.js"></script>
        ...
        //enableAutoWidth();
        json = '{ "Entry": { "Title": "", ' +
            '"Image": ["/wp-content/themes/SkipperMetzer/Images/Brochures/TELUGU-2.jpg",' +
            '"/wp-content/themes/SkipperMetzer/Images/Brochures/TELUGU-3.jpg",' +
            '"/wp-content/themes/SkipperMetzer/Images/Brochures/TELUGU-4.jpg" ] } }';
        addGallery(json);
    </script>
    <script type="text/javascript">
        var _gaq = _gaq || [];
